...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.agate.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.agate.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.agate
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.agate.rc \
    android.hardware.wifi@1.0-service.agate.xml
